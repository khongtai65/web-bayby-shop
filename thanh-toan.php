    ...
    <div class="container">
        ...
        <div class="checkout-container">
            ...
            <div class="checkout-form">
                ...
                <form id="checkout-form">
                    <div class="form-group">
                        ...
                        <input type="text" id="fullname" value="<?php echo htmlspecialchars($_SESSION['user_name'] ?? ''); ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input type="email" id="email" value="<?php echo htmlspecialchars($_SESSION['user_email'] ?? ''); ?>" required>
                    </div>
                    <div class="form-group">
                        <label>Số điện thoại</label>
                        <input type="tel" id="phone" value="<?php echo htmlspecialchars($_SESSION['user_phone'] ?? ''); ?>" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="order-summary">
                ...
                <button onclick="completeCheckout()" class="btn btn-primary btn-large">✅ Hoàn tất đơn hàng</button>
                <a href="gio-hang.php" class="btn btn-secondary">← Quay lại</a>
            </div>
        </div>
    </div>
